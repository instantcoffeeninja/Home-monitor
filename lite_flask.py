"""Small Flask-compatible subset used when Flask is unavailable."""
...
class Flask:
    ...
    def run(self, host: str = "127.0.0.1", port: int = 5000) -> None:
        raise RuntimeError("Flask is not installed. Install dependencies from requirements.txt to run the server.")
