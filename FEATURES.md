...
Note: Replaced BaseHTTPRequestHandler with Flask routes, moved dashboard/history HTML into templates, added Flask dependency, and updated server tests to Flask test client.
